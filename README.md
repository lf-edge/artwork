...
<img src="securedeviceonboard/horizontal/color/securedeviceonboard-horizontal-color.png"  width="200" style="display:inline;vertical-align:middle;padding:2%">      &nbsp;  &nbsp;  &nbsp; <img src="securedeviceonboard/icon/color/securedeviceonboard-icon-color.png" width="125" style="display:inline;vertical-align:middle;padding:2%">
